...
def CarregaTextura():
    ...
    textura = Image.open("surface1.jpg")
    #textura = Image.open("surface2.jpg")
    #textura = Image.open("surface3.jpg")
    #textura = Image.open("surface4.jpg")
    #textura = Image.open("surface5.jpg")
